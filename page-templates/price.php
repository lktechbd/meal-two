										...
										<table class="table table-bordered price-plan">
											...
											<tbody>
												...
												foreach($meal_pricing_items as $meal_pricing_item):
													$meal_price_one_data = apply_filters('$meal_pricing_item',$meal_pricing_one_items[$meal_counter]);
													$meal_price_two_data = apply_filters('$meal_pricing_item',$meal_pricing_two_items[$meal_counter]);

												?>
												<tr>
													<td><strong><?php echo esc_html($meal_pricing_item) ;?></strong></td>
													<td><?php echo wp_kses_post($meal_price_one_data);?></td>
													<td><?php echo wp_kses_post($meal_price_two_data);?></td>
												</tr>
												<?php
												$meal_counter ++;
												endforeach;
