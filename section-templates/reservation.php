					...
					<div class="row mb-4">
						<div class="form-group col-md-4">
							...
							<div class="form-field-icon-wrap">
								...
								<input type="text" class="form-control res" id="name">
							</div>
						</div>
						<div class="form-group col-md-4">
							...
							<div class="form-field-icon-wrap">
								...
								<input type="email" class="form-control res" id="email">
							</div>
						</div>
						<div class="form-group col-md-4">
							...
							<div class="form-field-icon-wrap">
								...
								<input type="text" class="form-control res" id="phone">
							</div>
						</div>
						...
						<div class="form-group col-md-4">
							...
							<div class="form-field-icon-wrap">
								...
								<select name="persons" id="persons" class="form-control res">
						...
						<div class="form-group col-md-4">
							...
							<div class="form-field-icon-wrap">
								...
								<input type="text" class="form-control res" id="date">
							</div>
						</div>
						<div class="form-group col-md-4">
							...
							<div class="form-field-icon-wrap">
								...
								<input type="text" class="form-control res" id="time">
							</div>
						</div>
					</div>
					<div class="row justify-content-center">
